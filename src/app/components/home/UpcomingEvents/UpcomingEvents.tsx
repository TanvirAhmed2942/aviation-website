...
const events = [
  {
    ...
    attendance: "25,000+",
    description:
      "The world's largest business aviation event featuring the latest aircraft, technology, and industry insights. Connect with industry leaders and explore the future",
    image:
  ...
  },
  {
    ...
    attendance: "200,000+",
    description:
      "Experience the glamour and excitement of Formula 1's most prestigious race. Charter a private jet to arrive in style at this iconic event featuring the world's top drivers navigating Monaco's legendary street circuit.",
    image:
  ...
  },
  {
    ...
    attendance: "70,000+",
    description:
      "The premier art show of the Americas featuring leading galleries from North America, Latin America, Europe, Asia, and Africa. Arrive effortlessly via private jet to this exclusive showcase of modern and contemporary",
    image:
